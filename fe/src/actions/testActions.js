...
export const listTests = () => async (dispatch) => {
    try {
        ...
        const {data} = await axios.get('https://kyez-backend.onrender.com/api/tests/')
...
export const listTestDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://kyez-backend.onrender.com/api/tests/${id}`)
...
export async function getTokenOrRefresh() {
    ...
    if (speechToken === undefined) {
        try {
            const res = await axios.get('https://kyez-backend.onrender.com/api/get-speech-token');
...
export async function getPhrase(text) {
    try {
        const res = await axios.post('https://kyez-backend.onrender.com/api/tests/phrase',
            {text},
            {
            headers: {
